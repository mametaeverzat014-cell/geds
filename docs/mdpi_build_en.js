...
col(P("The engine configuration is pinned (fixed seeds, stochasticity off); results are frozen by golden tests, and any numeric change is an explicit diff in the same commit. The statistical layer is deterministic (seed 20260718). The headline-numbers document and all figures are generated by scripts from artifacts; each figure ships with its numeric table. 147 automated tests, all green. Exact commands are in Appendix B."));
...
col(CODE([
  ...
  "python -m pytest                              # 147 tests, all green",
]));
